...
le fomat du texte par des valeurs standard*/
///************************************
void init_label(Lab_txt* l)
{
    ...
    l->lab.alignement = '3';
    l->lab.select = '1';
    l->Label=gtk_label_new(l->texte);
}///fin init_label(Lab_txt* l)
///**************************************************************
      ...
      if(!strcmp(crt->name,"texte"))
      {
        ...
        if(!strcmp(crt->name,"style")) strcpy(label->lab.style,crt->Value);
           ...
           if(!strcmp(crt->name,"font")) strcpy(label->lab.font,crt->Value);
            ...
            if(!strcmp(crt->name,"size")) strcpy(label->lab.taille,crt->Value);
            else

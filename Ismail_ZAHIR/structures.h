...
void make_button(button *button_info)
{
    ...
    {
        btn=gtk_button_new_with_mnemonic(button_info->mnemonic->info);
    ...
    if(button_info->signal->Idelem!=-1)
    {
        ...
        else if(strcmp(button_info->signal->info,"hiii")==0)g_signal_connect(btn,"clicked",G_CALLBACK(func1),im1);
        else if(strcmp(button_info->signal->info,"affi")==0)g_signal_connect(btn,"clicked",G_CALLBACK(func2),im1);
    }
...
GtkWidget *make_menu_bar(menu_item *menu_item_info,GtkWidget *mn_bar)
{
    ...
    {
        if (strcmp(menu_item_info->signal->info, "quit") == 0) g_signal_connect(item,"activate",G_CALLBACK(gtk_main_quit),NULL);
        else g_signal_connect(item,"activate",G_CALLBACK(on_menuitem_clicked),NULL);
    }
